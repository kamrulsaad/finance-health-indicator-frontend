...
export const truck = <i className="fa-solid fa-truck-field"></i>;
export const couch = <i className="fa-solid fa-couch"></i>;
export const loan = <i className="fa-solid fa-landmark"></i>;
export const account = <i className="fa-solid fa-money-check-dollar"></i>;
export const drawings = <i className="fa-solid fa-outdent"></i>;
export const expense = <i className="fa-solid fa-file-invoice"></i>;
